...
console.log(`\nAnalyzed: ${inputPath}`)
console.log(`Found ${report.summary.total} findings (errors: ${report.summary.bySeverity.error}, warnings: ${report.summary.bySeverity.warning}, info: ${report.summary.bySeverity.info})\n`)
