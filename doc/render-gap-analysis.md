...
#### P1-1 · Element registry + incremental rendering; single scene layer shared by canvas & editor — **L** (largest single item; prerequisite for P1-2/3/4 being cheap)
...
#### P1-5 · Real text measurement with SSR-safe fallback — **M**
...
#### P1-6 · Connection docking: crop edges to true shape outline — **M**
