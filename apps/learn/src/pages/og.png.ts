...
function ogSvg(title: string, subtitle: string): string {
  ...
  <text x="80" y="568" font-family="system-ui,-apple-system,sans-serif" font-size="22" fill="#8888a8">learn.bpmnkit.com</text>
</svg>`
}

export const GET: APIRoute = () => {
	const svg = ogSvg("BPMN Kit Learn", "Interactive BPMN tutorials")
