...
description: Generate BPMN files from built-in templates, CompactDiagram JSON, or by patching an existing file — and TypeScript types for job workers from BPMN.
sidebar:
  order: 2
---
