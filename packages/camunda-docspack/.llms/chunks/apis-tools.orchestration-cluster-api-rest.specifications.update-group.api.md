...
Request body:
  application/json: GroupUpdateRequest (required)
    name (string, required) — The new name of the group.
    description (string) — The new description of the group.

Responses:
  200 GroupUpdateResult — The group was updated successfully.
...
---
Source: https://docs.camunda.io/docs/next/apis-tools/orchestration-cluster-api-rest/specifications/update-group.api
