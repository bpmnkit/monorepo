...
`POST /batch-operations/{batchOperationKey}/suspension`
...
Responses:
  204 — The batch operation pause request was created.
...
---
Source: https://docs.camunda.io/docs/next/apis-tools/orchestration-cluster-api-rest/specifications/suspend-batch-operation.api
