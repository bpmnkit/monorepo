...
- **SaaS**: Follow the [OIDC-based Authentication guide](https://docs.camunda.io/docs/next/apis-tools/orchestration-cluster-api-rest/orchestration-cluster-api-rest-authentication#using-a-token-oidcjwt) for SaaS
- **Self-Managed**: Follow the [OIDC-based Authentication guide](https://docs.camunda.io/docs/next/apis-tools/orchestration-cluster-api-rest/orchestration-cluster-api-rest-authentication#using-a-token-oidcjwt) for Self-Managed
