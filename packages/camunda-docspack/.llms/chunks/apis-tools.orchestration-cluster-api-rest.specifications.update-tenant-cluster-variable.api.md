...
`PUT /cluster-variables/tenants/{tenantId}/{name}`
...
---
Source: https://docs.camunda.io/docs/next/apis-tools/orchestration-cluster-api-rest/specifications/update-tenant-cluster-variable.api
