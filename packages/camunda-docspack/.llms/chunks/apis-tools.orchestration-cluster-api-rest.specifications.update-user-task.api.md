...
Request body:
  application/json: UserTaskUpdateRequest
    changeset (Changeset)
...
Responses:
  204 — The user task was updated successfully.
...
---
Source: https://docs.camunda.io/docs/next/apis-tools/orchestration-cluster-api-rest/specifications/update-user-task.api
