...
This document outlines unary-tests and examples.
...
such as [invoking a function](https://docs.camunda.io/docs/next/components/modeler/feel/language-guide/feel-functions#invocation).
...
---
Source: https://docs.camunda.io/docs/next/components/modeler/feel/language-guide/feel-unary-tests
