...
Responses:
  200 HistoryBackupInfo[] — The list of history backups.
...
---
Source: https://docs.camunda.io/docs/next/apis-tools/orchestration-cluster-api-rest/specifications/list-history-backups.api
