...
This document outlines various functions and examples.

### Invocation

Invokes a built-in function (e.g. [`contains()`](https://docs.camunda.io/docs/next/components/modeler/feel/builtin-functions/feel-built-in-functions-string#containsstring-match)) or a user-defined
...
---
Source: https://docs.camunda.io/docs/next/components/modeler/feel/language-guide/feel-functions
