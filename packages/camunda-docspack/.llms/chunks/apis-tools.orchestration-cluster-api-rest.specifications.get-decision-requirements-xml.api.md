...
Responses:
  200 string — The XML of the decision requirements is successfully returned.
...
---
Source: https://docs.camunda.io/docs/next/apis-tools/orchestration-cluster-api-rest/specifications/get-decision-requirements-xml.api
