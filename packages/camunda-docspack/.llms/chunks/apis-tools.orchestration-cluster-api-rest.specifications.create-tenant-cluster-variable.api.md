...
`POST /cluster-variables/tenants/{tenantId}`
...
Responses:
  ...
  404 ProblemDetail — The tenant with the given ID was not found.
  409 ProblemDetail — A cluster variable with this name already exists for the given tenant.
  500 ProblemDetail — An internal error occurred while processing the request.

---
Source: https://docs.camunda.io/docs/next/apis-tools/orchestration-cluster-api-rest/specifications/create-tenant-cluster-variable.api
