...
Responses:
  200 ProcessDefinitionResult — The process definition is successfully returned.
...
---
Source: https://docs.camunda.io/docs/next/apis-tools/orchestration-cluster-api-rest/specifications/get-process-definition.api
