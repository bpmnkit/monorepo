...
Request body:
  application/json: UserTaskCompletionRequest
...
Responses:
  204 — The user task was completed successfully.
...
---
Source: https://docs.camunda.io/docs/next/apis-tools/orchestration-cluster-api-rest/specifications/complete-user-task.api
