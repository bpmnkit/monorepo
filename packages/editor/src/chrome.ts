 ...
 * or blur; square; depth is a 1px hairline) and the *accent*. The **ground**
 * stays per-theme, because the editor ships a dark default, a light theme and a
 * deliberate `neon` white-label theme, and only the ground distinguishes them.
 *
 ...
 * editor already owns: `data-bpmnkit-hud-theme` on `document.body`, absent for
 * the dark default.
 *
