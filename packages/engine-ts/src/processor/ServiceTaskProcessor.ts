...
/**
 * Processes BPMN service tasks.
 *
 * Mirrors `io.camunda.zeebe.engine.processing.bpmn.task.ServiceTaskProcessor`.
 *
 * Service tasks are **job-based wait states**: they create a job during activation
 * and wait for a worker to complete it. When the job completes, the engine
 * triggers the element's completion.
 *
 * ## Lifecycle
 *
 ...
 */
export class ServiceTaskProcessor
