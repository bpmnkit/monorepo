...
/**
 * Processes BPMN business rule tasks.
 *
 * Mirrors `io.camunda.zeebe.engine.processing.bpmn.task.BusinessRuleTaskProcessor`.
 *
 * Business rule tasks are **job-based wait states**: they create a job during
 * activation and wait for a worker (typically a DMN evaluation worker) to
 * complete it. The lifecycle is identical to service tasks.
 *
 * ## Lifecycle
 *
 ...
 */
export class BusinessRuleTaskProcessor
